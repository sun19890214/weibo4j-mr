...
public class Favorites extends WeiboResponse implements java.io.Serializable {
  ...
  public static List<Favorites> constructFavorites(Response res)
  ...
  public String toString() {
    return "Favorites [" + "favorited_time=" + favoritedTime + ", status="
        + status.toString() + ", FavoritesTag="
        + ((tags == null) ? "null" : tags.toString()) + ", total_number = "
        + totalNumber + "]";
  }
