...
public class Suggestion extends Weibo {
  ...
  public JSONArray suggestionsUsersMayInterested() throws WeiboException {
    return client.get(
        WeiboConfig.getValue("baseURL")
            + "suggestions/users/may_interested.json").asJSONArray();
  }
  ...
  public JSONArray suggestionsUsersMayInterested(int count, int page)
    ...
    return client.get(
        ...
        new PostParameter[] { new PostParameter("count", count),
            new PostParameter("page", page) }).asJSONArray();
  }
  ...
  public UserWapper suggestionsUsersByStatus(String content, int num)
    ...
    return User
        .constructWapperUsers(client.get(WeiboConfig.getValue("baseURL")
            + "suggestions/users/by_status.json", new PostParameter[] {
   ...
   * @since JDK 1.5
   */
  public StatusWapper suggestionsStatusesHot(int type, int isPic)
      throws WeiboException {
  ...
  public StatusWapper suggestionsStatusesHot(int type, int isPic, Paging page)
      throws WeiboException {
    return Status.constructWapperStatus(client.get(
        WeiboConfig.getValue("baseURL") + "suggestions/statuses/hot.json",
        new PostParameter[] { new PostParameter("type", type),
